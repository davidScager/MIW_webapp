...
INSERT INTO Asset (name, apiName ,abbreviation, description, valueInUsd, adjustmentFactor, valueYesterday, valueLastWeek, valueLastMonth) Values ('XRP','XRP','XRP','Ripple is often tought as the same' ,'1.28','1', '1', '1', '1');
...
INSERT INTO Asset (name, apiName ,abbreviation, description, valueInUsd, adjustmentFactor, valueYesterday, valueLastWeek, valueLastMonth) Values ('Theta', 'Theta','THETA','A big part of the streaming sector' ,'8.29','1', '1', '1', '1');
...
INSERT INTO Asset (name, apiName ,abbreviation, description, valueInUsd, adjustmentFactor, valueYesterday, valueLastWeek, valueLastMonth) Values ('Dollar','Dollar', 'USD' ,'Basic value in this bank', 1, 1, '1', '1', '1');
